...
namespace Protocol {
    ...
    namespace TYPE {
        ...
        static constexpr const char* GET_AGENTS = "get_agents";
        static constexpr const char* AGENT_STATUS = "agent_status";
        static constexpr const char* CONNECT_AGENT= "connect_agent";
    }
